...
public class Administrador extends JFrame implements ActionListener {
    ...
    public Administrador() {
        ...
        pest1.setBackground(new Color (131, 193, 255));
        JPanel pest2 = new JPanel(null);
        pest2.setBackground(new Color (131, 193, 255));
        JPanel pest3 = new JPanel(null);
        pest3.setBackground(new Color (131, 193, 255));
        ...
        btnActualizar1.setBounds(800, 90, 180, 50);
        ...
        btnEliminar1.setBounds(1000, 90, 180, 50);
       ...
       lbl4.setBackground(new Color (118, 165, 217));
        ...
        String[] columnsNames = {"Código","Nombre", "Apellido", "Especialidad", "Contraseña","Género","Teléfono","Edad"};
        // Crear una instancia de JTable con los datos y nombres de columna
        JTable table_estudiante = new JTable(Array.convertirDatosDoctores_tabla(), columnsNames);
        ...
        scrollPane.setBackground(new Color (118, 165, 217));
       ...
       paciente.setBackground(new Color (118, 165, 217));
        // Hacer que el JLabel sea opaco para que se pueda ver el color de fondo
        ...
        // Estable_estudiantecer el tamaño de la fuente del JLabel, negrita y tamaño 24
        paciente.setFont(new Font(paciente.getFont().getFontName(), Font.BOLD, 24));
        // Hacer que el JLabel sea visible
        ...
        // Crear una instancia de JTable con los datos y nombres de columna
        JTable table_paciente = new JTable(Array.convertirDatosDoctores_tabla(), columnspaciente);
        ...
        // Estable_estudiantecer el color de fondo del JLabel como GRIS CLARO
       productos.setBackground(new Color (118, 165, 217));
        // Hacer que el JLabel sea opaco para que se pueda ver el color de fondo
        ...
        // Estable_estudiantecer el tamaño de la fuente del JLabel, negrita y tamaño 24
        productos.setFont(new Font(productos.getFont().getFontName(), Font.BOLD, 24));
        // Hacer que el JLabel sea visible
        ...
        // Crear una instancia de JTable con los datos y nombres de columna
        JTable table_producto = new JTable(Array.convertirDatosDoctores_tabla(), columnsproducto);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource()==btn_salir) {
            ...
            this.dispose();
            CreatePacient vtn_crear= new CreatePacient();
    }
    }
