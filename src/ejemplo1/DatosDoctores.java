...
public class DatosDoctores {
    ...
    public static void agregarDoctores(int codigo, String nombre, String apellido, String especialidad, String contraseña, String telefono, String edad,  String genero){
